...
class BaseModel(object):
    ...
    async def update(self, connection, **kwargs):
        ...
        result = await db.update(connection, self.__table__, data=data, **kwargs)
        print(result)
        return result
    ...
    async def delete(self, connection, **kwargs):
        ...
        result = await db.delete(connection, self.__table__, o_id=o_id)
        return result

    async def get(self, connection, **kwargs):
        where = kwargs.pop('where', None)
        result = await db.get(connection, self.__table__, where=where, **kwargs)
        return result
    ...
    async def get_by_id(self, connection, **kwargs):
        ...
        if o_id is None:
            raise TypeError(f"kwargs.pop('o_id', self.id) must not return None. You have to set one of them!")
        result = await db.get_by_id(connection, self.__table__, o_id=o_id, **kwargs)
        return result
    ...
    async def get_by_key(self, connection, *, key: str = None, value: Any = None, **kwargs):
        ...
        result = await db.get_by_key(connection, self.__table__, key=key, value=value, **kwargs)
        return result
